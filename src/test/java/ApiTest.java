...
//    }
    ...
    public void projectTest3() {
        FakeValuesService fakeValuesService = new FakeValuesService(
                new Locale("en-GB"), new RandomService());
        Project project = Project.builder()
                .title(fakeValuesService.regexify("[A-Z]{5}"))
    ...
    public void projectTest4() {
        FakeValuesService fakeValuesService = new FakeValuesService(
                new Locale("en-GB"), new RandomService());
        Project project = Project.builder()
                .title(fakeValuesService.regexify("[A-Z]{1}"))
                .code(fakeValuesService.regexify("[A-Z]{7}"))
                .description(fakeValuesService.regexify("[A-Za-z1-9]{15}"))
                .access("all")
                .build();
        ResponseStatus actual = new ProjectAdapter().create(project, 200);
        assertEquals(actual.isStatus(), true);
